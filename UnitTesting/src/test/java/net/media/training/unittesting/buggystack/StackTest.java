package net.media.training.unittesting.buggystack;

import net.media.training.buggystack.Stack;
import net.media.training.buggystack.StackOverFlowException;
import net.media.training.buggystack.StackUnderOverFlowException;
...
public class StackTest {
    ...
    public void shouldAllowToPushMultipleElements() {
        ...
        stack.push(2);
        stack.push(3);
        assertEquals("Stack size should increase by the number of elements pushed", oldSize + 3, stack.size());
    }
    ...
    @Test(expected = StackUnderOverFlowException.class)
    ...
    public void peekElementShouldReturnTopElementOfStack() {
        ...
        stack.push(2);
        stack.push(3);
        assertEquals("Peek element should return top element",
                new Integer(3), stack.peek());
    }
    ...
    @Test
    public void testExistanceOfAnItem() {
        stack.push(1);
        stack.push(2);
        stack.push(3);
        stack.push(4);
